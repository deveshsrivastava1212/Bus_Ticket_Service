                                    ...
                                    <div className="col-md-6">
                                        <form onSubmit={e => submitData(e)}>
                                            <div className="form-group2">
                                                ...
                                                <input id="name" name="name" type="text" className="form-control sgnUp" onChange={e => handleChangeEvent(e, 'name')} />
                                            </div>
                                            <div class="form-group2">
                                                <label htmlFor="email">Email-ID:</label>
                                                <input required id="email" name="email" type="email" className="form-control sgnUp" onChange={e => handleChangeEvent(e, 'email')} />
                                            </div>
                                            <div class="form-group2">
                                                <label htmlFor="mob-number">Mobile-No.:</label>
                                                <input required id="mob-number" name="phone" type="text" className="form-control sgnUp" onChange={e => handleChangeEvent(e, 'mobile')} />
                                            </div>
                                            <div class="form-group2">
                                                <label htmlFor="dob">Date of Birth:</label>
                                                <input required id="dob" name="dob" type="text" className="form-control sgnUp" onChange={e => handleChangeEvent(e, 'dob')} />
                                            </div>
                                            ...
                                            <div class="form-group2">
                                                ...
                                                <input required id="password" name="password" type="password" className="form-control sgnUp" onChange={e => handleChangeEvent(e, 'password')} />
                                            </div>
                                            <div class="form-group2">
